    ...
    public partial class Carrito : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Response.Redirect("Error.aspx?ex= " + ex.Message + "&&descripcion= " + descripcion, false); //Para error tecnico - Averiguar si puedo hacer que me llegue un reporte al mail con este error
            }
        }
